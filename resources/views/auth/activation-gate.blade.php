                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <div class="space-y-4">
                            <form action="/dashboard/reseller" method="GET">
                                <x-ui.button type="submit" fullWidth="true" class="py-5 text-base flex items-center justify-center gap-3">
                                    BAYAR & AKTIFKAN SEKARANG
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                                </x-ui.button>
                            </form>
                            
                            <div class="flex justify-center items-center gap-2 text-[8px] font-bold uppercase tracking-[0.2em] text-slate-400">
