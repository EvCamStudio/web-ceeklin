<x-layouts.dashboard bgTheme="light">
    ...
    <div class="max-w-[1400px] mx-auto w-full" x-data="{
        ...
        successMsg: '',
        bonusRequests: [
            { id: 'WD-201', requester: 'Ahmad Fauzi', phone: '08123456789', city: 'Bandung', distributor: 'Pusat Distribusi Bandung', amount: 'Rp 1.050.000', period: 'Mei 2026', date: 'Hari ini, 11:20', bank_name: 'BCA', bank_account_number: '8830122344', bank_account_name: 'Ahmad Fauzi' },
            { id: 'WD-199', requester: 'Siti Aminah', phone: '08987654321', city: 'Bekasi', distributor: 'Teknik Karya Supply', amount: 'Rp 450.000', period: 'Mei 2026', date: '2 Jam Lalu', bank_name: 'MANDIRI', bank_account_number: '1220001234567', bank_account_name: 'Siti Aminah' }
        ],
        leaderboard: [
        ...
        handleConfirm() {
            // BACKEND-TODO: AJAX request to mark withdrawal as success
            this.viewMode = 'list';
        ...
        handleReject() {
            // BACKEND-TODO: AJAX request to mark withdrawal as rejected/pending
            this.viewMode = 'list';
            this.successMsg = 'Pengajuan Pencairan Ditangguhkan.';
            this.showSuccess = true;
            this.selectedRequest = null;
            setTimeout(() => { this.showSuccess = false; }, 3000);
        },
