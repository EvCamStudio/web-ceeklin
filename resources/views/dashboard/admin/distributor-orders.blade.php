                                        ...
                                        <div class="flex flex-col gap-3">
                                            <template x-for="status in ['Menunggu', 'Dikemas', 'Dikirim']">
                                                <button type="button" @click="newStatus = status; errors = {}"
                                                    ...
                                                    <div :class="newStatus === status ? 'bg-white border-white shadow-[2px_2px_0_rgba(0,0,0,0.2)] text-primary' : 'bg-gray-50 border-gray-300 text-transparent'" class="w-6 h-6 border-[3px] flex items-center justify-center transition-all duration-300">
