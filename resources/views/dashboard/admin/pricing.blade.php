            ...
            <div class="bg-white border-[4px] border-gray-900 shadow-[6px_6px_0_var(--color-primary-darkest)]">
                ...
                <div class="p-6">
                    ...
                    <div class="relative border-[3px] border-primary shadow-[4px_4px_0_var(--color-gray-900)] bg-white">
                        ...
                        <input id="harga-distributor" name="distributor_price" type="number" value="{{ $distributorPrice->price ?? 1250000 }}"
                    ...
                    <div class="flex justify-between mt-2">
                        <span class="text-[10px] font-bold tracking-widest text-slate-400 uppercase">Diperbarui: {{ $distributorPrice ? $distributorPrice->updated_at->diffForHumans() : 'N/A' }}</span>
                        <span class="text-[10px] font-bold text-green-700">Aktif</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border-[4px] border-gray-900 shadow-[6px_6px_0_var(--color-secondary)]">
                ...
                <div class="p-6">
                    ...
                    <div class="relative border-[3px] border-secondary shadow-[4px_4px_0_var(--color-gray-900)] bg-white">
                        ...
                        <input id="harga-reseller" name="reseller_price" type="number" value="{{ $resellerPrice->price ?? 1450000 }}"
                            aria-label="Harga per unit untuk Reseller"
                            class="w-full bg-transparent py-3 pl-12 pr-4 font-headline font-black text-2xl text-primary text-right focus:outline-none focus:ring-0">
                    </div>
                    <div class="flex justify-between mt-2">
                        <span class="text-[10px] font-bold tracking-widest text-slate-400 uppercase">Diperbarui: {{ $resellerPrice ? $resellerPrice->updated_at->diffForHumans() : 'N/A' }}</span>
                        <span class="text-[10px] font-bold text-green-700">Aktif</span>
                    </div>
                </div>
            </div>
