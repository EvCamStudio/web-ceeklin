    ...
    <div class="max-w-[1400px] mx-auto w-full" x-data="{
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
            ...
            <div class="flex gap-4">
                <button class="bg-gray-900 text-white px-6 py-3 text-[10px] font-headline font-black uppercase tracking-widest border-[3px] border-gray-900 shadow-[4px_4px_0_var(--color-secondary)] hover:bg-black active:translate-y-1 active:shadow-none transition-all flex items-center gap-3">
