        ...
        <div x-show="tab === 'account'" x-transition class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white border-[4px] border-gray-900 p-8 shadow-[10px_10px_0_var(--color-primary-darkest)]">
                ...
                <div class="space-y-6">
                    ...
                    <x-ui.input name="name" label="Nama Lengkap" value="Super Administrator" required />
                    <x-ui.input name="email" type="email" label="Email Terdaftar" value="admin@ceeklin.id" required />
                </div>
            </div>
            ...
            <div class="bg-neutral-light border-[4px] border-gray-900 p-8 shadow-[10px_10px_0_var(--color-gray-900)]">
                ...
                <div class="space-y-6">
                    <x-ui.input name="username" label="Username Baru" placeholder="Biarkan kosong jika tidak ganti" />
                    <div class="h-[1px] bg-gray-300 w-full my-4"></div>
                    <x-ui.input name="current_password" type="password" label="Kata Sandi Lama" placeholder="••••••••" />
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <x-ui.input name="new_password" type="password" label="Sandi Baru" placeholder="Min. 8 Karakter" />
                        <x-ui.input name="password_confirmation" type="password" label="Konfirmasi Sandi" placeholder="Ulangi Sandi" />
                    </div>
