...
<head>
    ...
    <title>Konfirmasi Pesanan - CeeKlin</title>
...
<body class="bg-neutral font-body text-gray-900 antialiased min-h-screen py-12 px-6 lg:px-24">
    ...
    <div class="max-w-7xl mx-auto mb-12 flex justify-between items-end border-b-2 border-neutral-border-light pb-6">
        <div>
            <h1 class="font-headline font-bold text-4xl uppercase text-primary tracking-tighter mb-2">KONFIRMASI PESANAN</h1>
            <p class="text-[10px] uppercase font-bold tracking-widest text-slate-500 max-w-md leading-relaxed">
                Portal Mitra Resmi. Periksa detail pesanan sebelum konfirmasi alokasi stok.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-start">
        ...
        <div class="w-full lg:w-3/5 flex flex-col gap-6">
            ...
            <x-ui.card noPadding="true" class="flex flex-col md:flex-row overflow-hidden border border-neutral-border-light">
                ...
                <div class="w-full md:w-[60%] p-8 bg-white flex flex-col justify-center">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-[10px] font-bold uppercase tracking-widest text-secondary-dark">ALOKASI RESELLER</span>
                    </div>
                    ...
                    <div class="bg-neutral-dark border-l-[6px] border-secondary-hover p-4 flex flex-col gap-1 mb-8">
                        <div class="flex justify-between items-end">
                            <span class="text-[10px] font-bold uppercase tracking-widest text-slate-800">HARGA SATUAN (RESELLER)</span>
                            <span class="font-headline font-bold text-xl text-primary">Rp 15.000</span>
                        </div>
                        <span class="text-[9px] text-slate-500 font-bold tracking-widest">HET: Rp 25.000 (Margin 40%)</span>
                    </div>
                    
                    <!-- Kuantitas Input Khusus Reseller -->
                    <div class="flex flex-col gap-2">
                        <label class="text-[10px] font-bold uppercase tracking-widest text-slate-800">MINIMUM KUANTITAS PESANAN</label>
                        ...
                        <p class="text-[9px] text-secondary-dark font-bold tracking-widest flex items-center gap-1">
                            ...
                            Kuantitas dikunci minimum 50 pcs untuk level reseller.
                        </p>
                    </div>
                </div>
            </x-ui.card>
            ...
            <x-ui.card class="bg-neutral-dark/50 border-0 shadow-none">
                <h3 class="font-headline font-bold text-lg uppercase text-primary mb-6">DETAIL MANIFEST PENGIRIMAN</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <p class="text-[9px] uppercase font-bold text-secondary-dark tracking-widest mb-1">TOTAL BERAT</p>
                        <p class="font-bold text-sm text-gray-900 border-b border-primary pb-1">125 Kg</p>
                    </div>
                    <div>
                        <p class="text-[9px] uppercase font-bold text-secondary-dark tracking-widest mb-1">DIMENSI</p>
                        <p class="font-bold text-sm text-gray-900 border-b border-primary pb-1">110x80x60 cm</p>
                    </div>
                    <div>
                        <p class="text-[9px] uppercase font-bold text-secondary-dark tracking-widest mb-1">KELAS HAZMAT</p>
                        <p class="font-bold text-sm text-gray-900 border-b border-primary pb-1">Korosif / Kelas 8</p>
                    </div>
                </div>
            </x-ui.card>
        ...
        <div class="w-full lg:w-2/5">
            <x-ui.card class="border-t-[6px] border-primary sticky top-12 p-8 lg:p-10">
                <h2 class="font-headline font-bold text-xl uppercase text-primary mb-6">METODE PEMBAYARAN</h2>
                ...
                <div class="bg-neutral-light border-y border-neutral-border py-8 flex flex-col items-center justify-center mb-8">
                    <span class="text-[10px] font-bold text-secondary-dark uppercase tracking-widest mb-2">TOTAL PEMBAYARAN</span>
                ...
                <form action="#" method="POST" class="flex flex-col gap-4">
                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-900 mb-2 border-b border-neutral-border-light pb-2">PILIH METODE PEMBAYARAN</label>
                        ...
                        <div class="border-[3px] border-transparent peer-checked:border-primary bg-[#Fdfcf7] p-5 flex items-center justify-between transition-all">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] font-bold text-slate-500 mt-1">Scan dari aplikasi bank manapun</p>
                                </div>
                            </div>
