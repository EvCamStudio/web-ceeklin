@php
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'route' => route('distributor.overview'),
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'route' => route('distributor.incoming-orders'),
                ...
                [
                    ...
                    'route' => route('distributor.resellers'),
                ...
                [
                    'key'   => 'sales-map',
                    'name'  => 'Peta Wilayah',
                    'route' => route('distributor.sales-map'),
        ...
        [
            ...
            'items' => [
                [
                    'key'   => 'inventory',
                    'name'  => 'Stok Gudang',
                    'route' => route('distributor.inventory'),
                ...
                [
                    ...
                    'route' => route('distributor.history'),
    ...
    $bottomMenu = [
        'key'   => 'settings',
        'name'  => 'Pengaturan',
        'route' => route('distributor.settings'),
