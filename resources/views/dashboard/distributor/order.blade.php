            ...
            <div class="bg-white border-[4px] border-gray-900 shadow-[8px_8px_0_var(--color-primary-darkest)]">
                ...
                <div class="p-6 flex flex-col gap-4">
                    ...
                    <div class="border-[3px] {{ $produk['qty'] > 0 ? 'border-primary' : 'border-neutral-border' }} p-5 flex items-center gap-5 hover:border-secondary transition-colors duration-150">
                        {{-- Slot Gambar Produk --}}
                        <div class="w-16 h-16 bg-neutral-light border-2 border-neutral-border flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="font-headline font-black text-lg text-primary mt-1">{{ $produk['harga'] }} <span class="text-xs text-slate-400 font-normal">/ unit</span></p>
                        </div>
                        {{-- Kontrol Qty --}}
                        <div class="flex items-center gap-2 flex-shrink-0">
                            ...
                            <input type="number" value="{{ $produk['qty'] }}" min="0" aria-label="Jumlah {{ $produk['nama'] }}"
                                class="w-16 text-center bg-neutral-light border-b-2 border-primary py-1 font-headline font-bold text-lg focus:outline-none">
            ...
            <div class="bg-white border-[4px] border-gray-900 shadow-[6px_6px_0_var(--color-gray-900)]">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="text-[10px] font-bold text-secondary uppercase tracking-widest" for="catatan-pengiriman">Catatan Pengiriman (Opsional)</label>
