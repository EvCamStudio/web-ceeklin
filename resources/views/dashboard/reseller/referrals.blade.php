        ...
        <div class="flex justify-end">
            <div class="relative w-full sm:w-48">
                <select x-model="period" aria-label="Pilih Periode Bonus"
                    class="appearance-none w-full bg-white border-[3px] border-gray-900 px-4 py-2 text-[10px] font-headline font-black uppercase tracking-widest text-primary focus:outline-none focus:border-secondary cursor-pointer pr-10">
        ...
        <div class="xl:col-span-2 flex flex-col gap-6">
            ...
            <div class="bg-white border-[4px] border-gray-900 shadow-[8px_8px_0_var(--color-primary-darkest)]">
                <div class="bg-primary px-6 py-3 flex items-center justify-between">
                    <span class="font-headline font-black text-white text-base uppercase tracking-tight">Rincian Bonus — <span x-text="period"></span></span>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                        <div class="space-y-4">
                            <div>
                                <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Volume Penjualan Pribadi</p>
                                <p class="font-headline font-black text-2xl text-gray-900 tracking-tighter">450 <span class="text-sm font-normal text-slate-400">PCS</span></p>
                                <p class="text-[10px] font-bold text-secondary uppercase mt-1">Estimasi Bonus: Rp 450.000</p>
                            </div>
                            <div>
                                <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Total Referral Order</p>
                                <p class="font-headline font-black text-2xl text-gray-900 tracking-tighter">1.200 <span class="text-sm font-normal text-slate-400">PCS</span></p>
                                <p class="text-[10px] font-bold text-primary uppercase mt-1">Estimasi Override (5%): Rp 600.000</p>
                            </div>
                        </div>
                        <div class="bg-neutral-light border-[3px] border-gray-900 p-5 flex flex-col items-center justify-center text-center shadow-[4px_4px_0_rgba(0,0,0,0.1)]">
                            <p class="text-[10px] font-black text-primary uppercase tracking-widest mb-2">Total Cair Periode Ini</p>
                            <h3 class="font-headline font-black text-4xl text-primary tracking-tighter italic mb-3">Rp 1.050.000</h3>
                            ...
                            <p class="text-[8px] font-bold text-slate-400 uppercase mt-3 leading-relaxed">Pastikan nomor rekening di pengaturan sudah benar sebelum melakukan pencairan.</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t-2 border-dashed border-neutral-border">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch border-[3px] border-primary shadow-[4px_4px_0_rgba(0,0,0,0.1)]">
                            <div class="flex-1 font-mono font-bold text-primary px-4 py-3 bg-white text-xs sm:text-sm tracking-widest break-all flex items-center">
                                ceeklin.id/ref/IM-778XQ
                            </div>
                            <button type="button" 
