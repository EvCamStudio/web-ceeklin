<x-layouts.dashboard bgTheme="dark">
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white border-[4px] border-gray-900 shadow-[8px_8px_0_var(--color-secondary)] flex flex-col sm:flex-row gap-0">
            <div class="bg-secondary flex items-center justify-center p-8 sm:w-48 flex-shrink-0">
                <div class="text-center">
                    ...
                    <p class="font-headline font-black text-white text-xs uppercase tracking-widest mt-2">AKTIF</p>
                </div>
            </div>
            <div class="p-6 flex-1">
                <h3 class="font-headline font-black text-4xl text-secondary tracking-tighter uppercase">Gold Tier</h3>
                <p class="text-xs text-slate-500 font-bold uppercase tracking-widest mt-1">Anggota sejak Agustus 2024</p>
                <div class="mt-4">
